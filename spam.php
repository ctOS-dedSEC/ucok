...
#Dilarang copyright blackSaiyan - Cybermedia 2019 14 10 12:30
...
echo $BB."\n::#:Author ::[Yehezkiel Anakhella Telaumbanua ] #";

echo $B."\n::#:Instagram ::[@bang_ucok14:]#";

echo $RR."\n::#:Github ::[http://github.com/blacksaiyan1001:] #";

echo $R."\n::#:Facebook ::[Yehezkiel Anakhella Telaumbanua :] #";
...
isset($argv[1]) OR die($RR."[!] []== Input NUMBER PLEASE==[] [!]\n".$X);
...
if(is_numeric($argv[1])) {
	...
	while(1) {
		...
		echo "[]UCOK Sending Message To[] # ".$G.$argv[1].$X."\n";	
...
echo "[]UCOK Sending Message To[] # ".$G.$argv[2].$X."\n";
